...
class DogTherapist extends StatefulWidget {
  const DogTherapist({super.key, this.rid});

  final String? rid;

  @override
  State<DogTherapist> createState() => _DogTherapist();
}

class _DogTherapist extends State<DogTherapist>
